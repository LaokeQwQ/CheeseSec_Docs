...
linkTitle: 防护
weight: 60
description: 涵盖 AST 语义分析引擎、自定义正则规则、IP/GeoIP、Bot 挑战验证、滑动窗口限流、ACL 与拦截页配置。
---
...
{{< nav-card title="流量限流" link="/zh/docs/cheesewaf/protection/ratelimit/" desc="数据平面高性能分片滑动窗口计数器限流与超出阈值后的排队/阻断策略。" />}}
